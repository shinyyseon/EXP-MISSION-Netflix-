    ...
    return (
        <FooterContainer>
            <FooterContent>
                <FooterLinkContainer>
                    <FooterTitle>
                        <FooterLinkTitle href={"https://www.facebook.com/NetflixKR"}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24"
                                 height="24" data-icon="FacebookStandard" aria-hidden="true"
                        ...
                        <FooterLinkTitle href={"https://www.instagram.com/netflixkr/"}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24"
                                 width="24" height="24" data-icon="InstagramStandard" aria-hidden="true"
                        ...
                        <FooterLinkTitle href={"https://x.com/netflixkr"}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24"
                                 width="24" height="24" data-icon="TwitterStandard" aria-hidden="true"
                        ...
                        <FooterLinkTitle href={"https://www.youtube.com/channel/UCiEEF51uRAeZeCo8CJFhGWw/featured"}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24"
                                 width="24" height="24" data-icon="YoutubeStandard" aria-hidden="true"
                    ...
                    <FooterLinkContent>
                        ...
                        <FooterLink href={"https://ir.netflix.net/ir-overview/profile/default.aspx"}>투자
                            정보(IR)</FooterLink>
                ...
                <FooterButton><button>서비스 코드</button></FooterButton>
                <FooterDesc>넷플릭스서비시스코리아 유한회사 통신판매업신고번호: 제2018-서울종로-0426호 전화번호: 00-308-321-0161 (수신자 부담)</FooterDesc>
                <FooterDesc>대표: 레지널드 숀 톰프슨</FooterDesc>
                <FooterDesc>이메일 주소: korea@netflix.com</FooterDesc>
                <FooterDesc>주소: 대한민국 서울특별시 종로구 우정국로 26, 센트로폴리스 A동 20층 우편번호 03161</FooterDesc>
                <FooterDesc>사업자등록번호: 165-87-00119</FooterDesc>
                <FooterDesc>클라우드 호스팅: Amazon Web Services Inc.</FooterDesc>
                <FooterDesc>공정거래위원회 웹사이트</FooterDesc>
